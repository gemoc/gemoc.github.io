...
All submissions have to follow the [the IEEE format] (https://www.ieee.org/conferences/publishing/templates.html) and must be [submitted electronically in PDF format via Easychair](https://easychair.org/my/conference?conf=gemoc2019). 
...
### Organizers 
<!--([contact](mailto:gemoc2019@gemoc.org))-->
