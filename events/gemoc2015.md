...
[![img]({{ site.baseurl }}{% link logo/models2015Logo1-150x150.png %})](http://www.modelsconference.org/)

# 3rd International Workshop on*The Globalization of Modeling Languages*
...
**09:00-09:15:** [Workshop opening]({{ site.baseurl }}{% link pub/20150928-GEMOC15/2015-09-GEMOC-intro.pdf%}) (B. Combemale)

**09:15-10:15:** Keynote (chair: *J. Gray*)

>  
>
> *![Bran Selic](https://media.licdn.com/mpr/mpr/shrink_200_200/p/2/000/003/1c7/20e66d2.jpg)*
>
> ## Keynote by [Bran Selic]({{ site.baseurl }}{% link events/gemoc2015.md %}#): “[Seeking Meaningful Relationships: A Challenge]({{ site.baseurl }}{% link pub/20150928-GEMOC15/Selic.Relationships.pdf %})“
>
...
>
> In their reputation for science it is usually asserted the best breakthroughs originated from analysts who wanted to know their own self the most appropriate questions. In my opinion, not only because of this, many of these individuals were fortunate and were in the right time and place thanks to their perseverance [write my essay](http://writer4sale.com/) This series will be the most crucial element of coming up with a learning. The time spent, time, strategy or even the affect associated with the report while in the controlled area be determined by this period really being administered in the right manner. On the flip side, also, it is most likely the most tedious stage to organize. There are thousands of factors that vary depending wholly on you and your rapport with the elected subject.
>
...
- **Programming against Multi-Version Metamodels: A Model Differencing and Virtualization Approach (paper, slides)**
  Robert Bill, *Vienna University of Technology*
  [Manuel Wimmer](http://www.big.tuwien.ac.at/staff/mwimmer),* Vienna University of Technology*
- **Towards a formal semantics of the TESL specification language (paper, slides)**
  [Hai Nguyen Van](http://perso.crans.org/nguyen-van), *University of Paris-Sud*
  [Thibaut Balabonski](https://www.lri.fr/~blsk), *University of Paris-Sud*
  [Frédéric Boulanger](http://wwwdi.supelec.fr/fb), *University of Paris-Sud* *& CentraleSupélec*
  [Safouan Taha](http://www.supelec.fr/359_p_10044/safouan-taha.html), *University of Paris-Sud & CentraleSupélec*
  [Benoît Valiron](http://www.monoidal.net/), *University of Paris-Sud* *& CentraleSupélec*
  [Burkhart Wolff](https://www.lri.fr/~wolff), *University of Paris-Sud* *& CentraleSupélec*
  Lina Ye, *University of Paris-Sud & CentraleSupélec*
- **Property-Based Methods for Collaborative Model Development (paper, slides)**
  [Marsha Chechik](http://www.cs.toronto.edu/~chechik), *University of Toronto*
  [Fabiano Dalpiaz](http://fabianodalpiaz.wordpress.com/), *City University London*
  Csaba Debreceni,  *Utrecht University*
  [Jennifer Horkoff](http://www.cs.utoronto.ca/~jenhork), * Budapest University of Technology and Economics*
  Istvan Rath, *Utrecht University*
  Rick Salay, *University of Toronto*
  Daniel Varro, *Utrecht University*
...
- BCOOL: A Behavioral Coordination Operator Language
- MoccML: A Meta-Language for the Concurrency Concern in DSLs
- Melange: Modular and Reusable DSL Design and Implementation
- Omniscient Debugging within the GEMOC Studio
- On the usefulness of Model Tying for Enterprise Architecture
...
This proposed 2015 edition of the GEMOC workshop will follow the successful previous two editions: [GEMOC at MODELS 2013]({{ site.baseurl }}{% link events/gemoc2013.md %}) in Miami, FL, USA, and [GEMOC at MODELS 2014]({{ site.baseurl }}{% link events/gemoc2014.md %}) in Valencia, Spain. This new edition will complete the state of the art and practice initiated last year. This edition will also investigate the language interfaces required in the context of the globalization of modeling languages, and the possible relationships with the viewpoint engineering. It will also strengthen the community that broadens the current DSML research focus beyond the development of independent DSMLs to a research focus that provides support for globalized DSMLs.

GEMOC 2015 is supported by [the GEMOC initiative]({{ site.baseurl }}/), which promotes research seeking to develop the necessary breakthroughs in software languages to support global software engineering, i.e., breakthroughs that lead to effective technologies supporting different forms of language integration, including language collaboration, interoperability and composability.
...
Each contribution must not exceed 6 pages in [the LNCS format](http://www.springer.com/computer/lncs?SGWID=0-164-6-793341-0) and [must be submitted electronically in pdf format via Easychair](https://www.easychair.org/conferences/?conf=gemoc2015).
...
### Organizers ([contact](mailto:gemoc2015@gemoc.org))

- [Benoit Combemale](http://people.irisa.fr/Benoit.Combemale/), INRIA and University of Rennes 1, France
- [Julien DeAntoni](http://www-sop.inria.fr/members/Julien.Deantoni/), University of Nice Sophia Antipolis, France
...
- [Julien DeAntoni](http://www-sop.inria.fr/members/Julien.Deantoni/), University of Nice Sophia Antipolis, France (chair)
- [Jeff Gray](http://gray.cs.ua.edu/), University of Alabama, USA (chair)
