...
pkg: <img title="the language is available as sample in the Eclipse GEMOC Studio." src="gallery/icons/gemoc_eclipse_package.png" width="16" height="16">
...
All these components can be installed from a Eclipse GEMOC Studio. Simply click on <i>Help &gt; Install Additional GEMOC Components</i>
